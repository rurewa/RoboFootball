...
void Joysticks() { // Левый джойстик вперед/назад. правый джойстик право/лево
  // назад //
  if (ps2x.Analog(PSS_LY) > 132 && ps2x.Analog(PSS_RX) < 132 && ps2x.Analog(PSS_RX) > 123) { // По оси Y > 130. Назад
  ...
  // вперед //
  if (ps2x.Analog(PSS_LY) < 123 && ps2x.Analog(PSS_RX) < 132 && ps2x.Analog(PSS_RX) > 123) { // По оси Y < 125. Вперед
  ...
  // кручение вправо //
  if (ps2x.Analog(PSS_RX) > 132 && ps2x.Analog(PSS_LY) < 132 && ps2x.Analog(PSS_LY) > 123 ) { // По оси X > 128. Вправо
  ...
  // кручение влево //
  if (ps2x.Analog(PSS_RX) < 123 && ps2x.Analog(PSS_LY) < 132 && ps2x.Analog(PSS_LY) > 123 ) { // По оси X > 128. Вправо
